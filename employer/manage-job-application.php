                                    ...
                                    <div id="project_fields">
                                        <div class="project-entry mb-3">
                                            ...
                                            <div class="row mt-2">
                                                <div class="col-md-6">
                                                    <label class="form-label">Start Date</label>
                                                    <input type="date" name="projects[0][start_date]" class="form-control">
                                                </div>
                                                <div class="col-md-6">
                                                    <label class="form-label">End Date</label>
                                                    <input type="date" name="projects[0][end_date]" class="form-control">
                                                </div>
                                            </div>
                                            <div class="row mt-2">
                                                <div class="col-md-12">
                                        ...
                                        <div class="certificate-entry mb-3">
                                            ...
                                            <div class="row mt-2">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="date" name="certificates[0][issue_date]" class="form-control">
                                                </div>
                                                <div class="col-md-6">
...
<div class="card">
    <h5 class="card-header d-flex justify-content-between align-items-center">
        ...
        <button id="sendToClientBtn" class="btn btn-primary d-flex align-items-center">
            <i class='bx bx-send me-1'></i>
            <span>Send Selected Applicants to Client</span>
            <span class="badge bg-white text-primary ms-2 selected-count">0</span>
        </button>
    </h5>
    <div class="card-body">
        <div class="row mb-4">
            <div class="col-md-4">
                ...
                <select class="form-select" id="positionFilter">
                    ...
                    $stmt = $connection->prepare("
                        SELECT DISTINCT apply_position 
                        FROM job_applications 
                        JOIN post ON job_applications.jobid = post.sno 
                        WHERE post.employer_id = ?
                    ");
                    $stmt->execute([$_SESSION['employer_id']]);
                    $positions = $stmt->fetchAll(PDO::FETCH_COLUMN);
                    foreach ($positions as $position) {
                        echo '<option value="' . htmlspecialchars($position) . '">' . 
                ...
                <select class="form-select" id="companyFilter">
                    ...
                    foreach ($companies as $company) {
                        echo '<option value="' . htmlspecialchars($company) . '">' . 
                             htmlspecialchars($company) . '</option>';
                    }
                    ?>
                </select>
            </div>
            <div class="col-md-4 d-flex align-items-end">
                ...
                <div class="ms-auto">
                    ...
                    <span class="fw-bold" id="resultCount">0</span>
                </div>
            </div>
        </div>
    </div>
                    ...
                    foreach ($applicants as $applicant) {
                        ...
                        echo '<td>
                                <input type="checkbox" 
                                       ...
                                       data-applied-id="' . $applicant['applied_id'] . '"
                                       ...
                                       data-position="' . htmlspecialchars($applicant['apply_position']) . '"
                                       data-company="' . htmlspecialchars($applicant['company']) . '"
        ...
        const html = `
            <div class="education-entry mb-3">
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-md-6">
                        <label class="form-label">End Date</label>
                        <input type="date" name="education[${educationCount}][end_date]" class="form-control">
                    </div>
                </div>
                <div class="row mt-2">
                    <div class="col-md-12">
        ...
        const html = `
            <div class="project-entry mb-3">
                ...
                <div class="row mt-2">
                    <div class="col-md-6">
                        <label class="form-label">Start Date</label>
                        <input type="date" name="projects[${projectCount}][start_date]" class="form-control">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">End Date</label>
                        <input type="date" name="projects[${projectCount}][end_date]" class="form-control">
                    </div>
                </div>
                <div class="row mt-2">
                    <div class="col-md-12">
        ...
        const html = `
            <div class="experience-entry mb-3">
                ...
                <div class="row mt-2">
                    <div class="col-md-6">
                        <label class="form-label">Start Date</label>
                        <input type="date" name="experience[${experienceCount}][start_date]" class="form-control">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">End Date</label>
                        <input type="date" name="experience[${experienceCount}][end_date]" class="form-control">
                    </div>
                </div>
                <div class="row mt-2">
                    <div class="col-md-12">
        ...
        const html = `
            <div class="certificate-entry mb-3">
                <div class="row">
                    <div class="col-md-6">
                        <label class="form-label">Certificate Name</label>
                        <input type="text" name="certificates[${certificateCount}][certificate_name]" class="form-control">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Issued By</label>
                        <input type="text" name="certificates[${certificateCount}][issued_by]" class="form-control">
                    </div>
                </div>
                <div class="row mt-2">
                    <div class="col-md-6">
                        <label class="form-label">Issue Date</label>
                        <input type="date" name="certificates[${certificateCount}][issue_date]" class="form-control">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Valid Till</label>
        ...
        const html = `
            <div class="document-entry mb-3">
                <div class="row">
                    <div class="col-md-5">
                        <label class="form-label">Document Type</label>
                        <select name="documents[${documentCount}][type]" class="form-control">
                            <option value="">Select Document Type</option>
                            <option value="Offer Letter">Offer Letter</option>
                            <option value="ID Proof">ID Proof</option>
                            <option value="Address Proof">Address Proof</option>
...
<div class="modal fade" id="sendEmailModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Send Applicants Details to Client</h5>
                ...
                <form id="sendEmailForm">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="emailSubject" 
                               value="Candidate Profiles for Your Review" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label class="form-label">Selected Candidates:</label>
                        <div id="selectedCandidatesList" class="border p-3 rounded">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const selectedCountBadge = sendToClientBtn.querySelector('.selected-count');
    const emailModal = new bootstrap.Modal(document.getElementById('sendEmailModal'));
    
    // Add some styling to the button
    sendToClientBtn.style.transition = 'all 0.3s ease';
    ...
    applicantCheckboxes.forEach(checkbox => {
        checkbox.addEventListener('change', function() {
            ...
            selectAllCheckbox.checked = 
                document.querySelectorAll('.applicant-checkbox:checked').length === 
    ...
    function updateSendButton() {
        ...
        sendToClientBtn.disabled = checkedCount === 0;
        selectedCountBadge.textContent = checkedCount;
        
        // Update button appearance based on selection
        if (checkedCount > 0) {
            sendToClientBtn.classList.remove('btn-primary');
            sendToClientBtn.classList.add('btn-success');
            selectedCountBadge.classList.remove('text-primary');
            selectedCountBadge.classList.add('text-success');
        } else {
            sendToClientBtn.classList.remove('btn-success');
            sendToClientBtn.classList.add('btn-primary');
            selectedCountBadge.classList.remove('text-success');
            selectedCountBadge.classList.add('text-primary');
        }
    }

    // Handle send button click
    sendToClientBtn.addEventListener('click', function() {
        const selectedApplicants = [];
        document.querySelectorAll('.applicant-checkbox:checked').forEach(checkbox => {
            selectedApplicants.push({
                id: checkbox.dataset.id,
                applied_id: checkbox.dataset.appliedId,
        ...
        // Populate selected candidates list
        const candidatesList = document.getElementById('selectedCandidatesList');
        candidatesList.innerHTML = selectedApplicants.map(applicant => `
            <div class="mb-2">
                <strong>${applicant.name}</strong> - ${applicant.position}
            </div>
        `).join('');
    ...
    document.getElementById('sendEmailForm').addEventListener('submit', async function(e) {
        ...
        try {
            const response = await fetch('send_applicants_email.php', {
                method: 'POST',
                headers: {
...
#sendToClientBtn:hover:not(:disabled) {
    transform: translateY(-1px);
    box-shadow: 0 4px 8px rgba(0,0,0,0.1);
}

#sendToClientBtn:active:not(:disabled) {
...
function applyFilters() {
    ...
    tableRows.forEach(row => {
        const position = row.querySelector('[data-position]')?.dataset.position.toLowerCase();
        const company = row.querySelector('[data-company]')?.dataset.company.toLowerCase();
...
function updateSelectAllCheckbox() {
    const visibleCheckboxes = Array.from(document.querySelectorAll('tr:not([style*="display: none"]) .applicant-checkbox'));
    const selectAllCheckbox = document.getElementById('selectAll');
    
    if (visibleCheckboxes.length > 0) {
        selectAllCheckbox.checked = visibleCheckboxes.every(checkbox => checkbox.checked);
    } else {
        selectAllCheckbox.checked = false;
    }
}

// Modify the existing selectAll checkbox handler
selectAllCheckbox.addEventListener('change', function() {
    const visibleCheckboxes = document.querySelectorAll('tr:not([style*="display: none"]) .applicant-checkbox');
