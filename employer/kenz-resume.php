...
foreach ($skills as $skill) {
    ...
    $html .= '<li style="background-color: '.$secondary_color.'; color: #fff; text-align: left; display: flex; align-items: center; gap: 8px;">
...
$html .= '</ul>
      ...
      <div class="company-details">
       <p style="font-size: small;">' . htmlspecialchars($employer['company_name']) .'</p>
       <p style="font-size: small;">' . htmlspecialchars($employer['email']) . '</p>
       <p style="font-size: small;"> +' . htmlspecialchars($employer['country_code']). '-'. htmlspecialchars($employer['contact_number']) . '</p>
       </div>
    </aside>
