...
<?php
  ...
  <div class="card-body pt-1">
    ...
    <div class="row mb-4 mt-0 bg-light p-3">
        ...
        <div class="col-md-4 text-muted text-right"><a href="index.php" class="btn btn-primary mr-2"><i class="fas fa-long-arrow-alt-left mr-2"></i> Back to List</a></div>
    ...
    <div class="row">
        ...
        <div class="col-md-6 text-end" style="text-align: right;">
            <a href="application.php?postid=<?php echo $joblist['sno']; ?>&jobtitle=<?php echo $joblist['job_title']; ?>&rolecategory=<?php echo $joblist['role_category']; ?>" class="btn btn-success mt-2"><i class="fas fa-arrow-right"></i> Apply Now</a>
        </div>
    </div>
