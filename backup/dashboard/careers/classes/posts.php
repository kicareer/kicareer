...
// Insert Items
   ...
   public function post_insert($job_title, $job_description, $exper_min, $exper_max, $salary_min, $salary_max, $joblocation, $role, $openings, $industry_type, $function_area, $emp_type, $role_category, $education, $skills) {
     
     $post_date = date("y/m/d");
     $post_time = date("h:i:s A");

      $sql  = "INSERT INTO post (job_title, job_description, exper_min, exper_max, salary_min, salary_max, location, role_category, openings, industry_type, function_area, emp_type, role, education, skills, post_date, post_time) VALUES ('$job_title', '$job_description', '$exper_min', '$exper_max', '$salary_min', '$salary_max', '$joblocation', '$role', '$openings', '$industry_type', '$function_area', '$emp_type', '$role_category', '$education', '$skills', '$post_date', '$post_time')";
      $stmt = $this->dbConn->prepare($sql);
      $stmt->execute();
