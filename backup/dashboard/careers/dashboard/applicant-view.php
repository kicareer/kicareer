     ...
     <div class="row">
         ...
         <div class="col-md-8">
              <div class="block">
                 ...
                 <div class="mb-2"><span class="title">Resume : </span> <a href="../uploads/<?php echo $applicants['resume']; ?>" target="blank">View Resume</a></div>
                 <div class="mb-2"><span class="title">Kenz Resume : </span> <a href="../uploads/<?php echo $applicants['kenz_resume']; ?>" target="blank">View Resume</a></div>
