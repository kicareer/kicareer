...
?>
	...
	<div class="container">
		...
		<div class="row justify-content-center">
            ...
            <div>
            <input type="number" placeholder="Enter your mobile number" class="form-control" style="width: 80%;float: right;" name="phone" required>
            <select name="countryCode" class="form-control" style="width:150px;;" id="" required="">
            ...
            <option>--SELECT--</option>
              ...
              ?>
  				...
  				<div class="mb-3">
    				<label class="form-label">Attach Picture <span class="text-danger">*</span></label>
  				...
  				<div class="mb-3">
    				...
    				<input type="text" placeholder="Enter Current Employer" class="form-control" id="current_emp" name="current_emp" required>
    				<div class="form-text"></div>
  				</div>
  				
  				<div class="mb-3">
    				<label class="form-label">Current Salary <span class="text-danger">*</span></label>
    				<input type="number" placeholder="Enter Current Salary (In numbers only)" class="form-control" id="current_sal" name="current_sal" required>
    				<div class="form-text"></div>
  				</div>
  ...
  if(isset($_POST['submit'])) {
      ...
      // FILE UPLOAD 
        ...
        // resume
         ...
         $add_post = $addpost->application_insert($jobid, $name, $email, $phone, $residence, $dob, $profile_image, $current_emp, $current_sal, $experience, $apply_position, $job_city, $notice_period, $resume, $role_category);
          ...
          $send_msg="
            Dear " . $name . ",<br>
            <p>We&#39;ve received your application, and are excited that you are interested to join Master Changan Partner Dealership!.</p>
            ...
            <p>Since our recruitment needs are constantly evolving due to a progressive business trajectory, we encourage you to keep exploring fresh job opportunities by visiting our <a href='https://changan.com.pk/'> <span><img src='https://lh3.googleusercontent.com/nnzqe2FKSMcbIzFQGRJh97pa22WgyOMLjwOBNe8L92CvbDPdXCS3ZweMrFebk0zrSM8ZzoheVLlOOJAekYfRYj_UIFbJ8-YwtzKNJR9qqLdHtyt2jIO1HYcmuTLtjleuu5SGRKy88A=s28-p-k' style='width:40px;'></span> Website</a>  and pages on <a href='https://www.facebook.com/changan.pk/'><span><img src='https://lh3.googleusercontent.com/8CKfIt59lQQ9dbhEby-zkSAioE4q5GTUk9pyubNb3qOLpvjiADD2aC40octFtdO3_9OV0r2DJ3o_c-RAnftd37aUU0eQ2y-KjWLSxLvd6rnlaf5eZ0cO5UWyTzTHNvpa-0pGYMArfg=s28-p-k' style='width:40px;'></span> Facebook</a>, <a href='https://www.linkedin.com/company/changan-pk/?viewAsMember=true'> <span><img src='https://lh3.googleusercontent.com/xnGVDfUuHP0XLqZnl8JRztirpEYUdbmk6RGmVzyGKSQ2CIbsbd8qgJCc_Qt31Tc-JjUuDIRStDp_bRqbNJ_A8odqtN89gdWwFb4wQ7Xzvv3mT7mLSMAN-rlQIkR3Mpwr6RFsaw6c_w=s28-p-k' style='width:40px;'></span> Linked In</a>.</p>
            <p>Thanks again for your interest to be a part of Master Changan family. We wish you all the best in your career!</p>
            <p>Best Regards,<br>Human Resources.</p>
            <img src='https://lh3.googleusercontent.com/22KjJUGClzPsrUEtwjE410D31E_ZyNtKiPfybeXxQqnUhMj_8GUK6snVe5tQkada2-xz2H8nBceZXVg5fbEvcYd4l9p1n1mcQwMpeW_2sa2qO0KRHW3_gQSEgUMJdFyUKB1wus69FA=w2400' style='width:120px;'>
            <hr>
            <p><b>About us:</b></p>
            <p>Master Changan Motors Limited (MCML) is a Joint Venture Company (JVC) formed between Master Motors Limited and Changan Automobile Ltd, China&#39;s #1 domestic automotive company. Changan Auto boasts an industrial history stretching back 153 years. With 32 years of experience in manufacturing and selling passenger vehicles.</p>
            <p>The JV between Changan Auto and Master Group was formed in 2018 with a $136 Million investment and is the first JV in auto industry in 3 decades. The state of the art assembly plant, located at Port Qasim Industrial Area was built in a record 13 months and has a total annual production capacity of 50,000 units.</p>
            <p>MCML currently produces quality products including SUVs, Sedans, MPVs and Pickups and ensures they exceed International standards and quality protocols. As Changan&#39;s only Right Hand Drive production facility outside of China, MCML serves as the RHD export hub to the world.</p>
            <p>Each day, more than 8,500 consumers buy a new Changan internationally. With 6,000 sales and service facilities in more than 60 countries and more than 150,000 professional team members globally, we stand ready to provide considerate and prompt service 24 hours a day.</p>
            <img src='https://lh3.googleusercontent.com/_fJV7ctpM3uBliTyGd1sDXzyfeDutCBKJkH7rLPqudG0zhuAZ6RLtra_B5Ul0k0j6Zf2VtuMkQrbZ3xJ8lyMxtErIXyJD-LB3yn80CQw9PkgT-6kbhXQDD5OkL-pOyy_ALGhJcgF_g=w2400' style='width:100%'>
            ";
          $envelope["from"]= $login;
          $envelope["to"]  = $to;
          $envelope["cc"]  = "";
          ...
          $bcc='';
          $rpath='';
          $mail=imap_mail ($to , $subject , $send_msg , $headers , $cc , $bcc , $rpath );
