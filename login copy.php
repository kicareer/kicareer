...
<head>
  ...
  .card-my{
    background: linear-gradient(to right, #025984, #004481) !important;
    border-radius: 80px !important; 
    /* padding: 70px 40px !important;  */
    /* background: linear-gradient(0deg,  #002552, #004481) !important; */
    border: none !important;
    box-shadow: 0 0 35px 0 rgba(255, 255, 255, 0.75) !important;
    position: relative;
    opacity: .9 !important;
    z-index: 0 !important;
    width: 90% !important;
...
<div class="col-md-4 d-flex align-items-center justify-content-center" style="background: radial-gradient(circle at 50% 50%, #00537B, #0C2947); height: 95vh;">
        ...
        <div class="container-fluid text-center border-top">
            <span class="text-light mt-3 d-block">&copy; 2025 Kenz. All rights reserved.</span>
        </div>
