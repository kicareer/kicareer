       ...
       ?>
        ...
        <section class="p-b-0" style="background:url(gplay.png) !important;height: 200px">
            <div class="container-fluid">
                ...
                <h3 class="text-center">View Job Details</h3>
            </div>
        </section>
        <div class="container-fluid">
            <!-- <div class="col-md-12">
                ...
                <div class="col-md-8">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <p class="m-0">
                                      ...
                                      <span><?=$key['role']?> <i class="icon-star" style="color: gold"></i> (11 Reviews)</span>
                                    </p>
                                    <div>
                    ...
                    <?php
                        if ($key['employer_id']=='admin') {
                            ...
                            $fetch_com=$conn->prepare("SELECT e.* FROM employer_tbl e LEFT JOIN post p ON p.employer_id = e.id ");
                            $fetch_com->execute();
